...
use sqlite3ext_sys::{
    ...
    sqlite3_value_text, sqlite3_value_type, sqlite3_vfs_unregister, sqlite3_vfs_register, sqlite3_vfs_find, sqlite3_vfs, sqlite3_file_control, sqlite3_create_window_function,
};
...
// SQLITE_STATIC == 0
// SQLITE_TRANSIENT == -1
// TODO instead of making a copy every time, let's transfer ownership to some Rust box
